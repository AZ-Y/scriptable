...
[Script]
bckid_获取token = type=http-response,pattern=^https:\/\/api\.bckid\.com\.cn\/operation\/front\/bonus\/userTask\/list,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/AZ-Y/scriptable/main/babycarerw.js
