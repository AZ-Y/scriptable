...
*/
const $ = new Env('顾家家居');
const kukahome = ($.isNode() ? JSON.parse(process.env.kukahome) : $.getjson("kukahome")) || [];
let notice = '';
...
async function main() {
    ...
    for (const item of kukahome) {
        ...
        // 签到接口
        let sign = await commonPost('https://mc.kukahome.com/club-server/member/sign', {}, authorization);
