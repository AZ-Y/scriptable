[Script]
朋友_获取cookie = type=http-response,pattern=^https:\/\/smp\-api\.iyouke\.com\/dtapi,script-path=https://raw.githubusercontent.com/AZ-Y/scriptable/main/jgpy.js,requires-body=1,max-size=0
