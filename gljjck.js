...
[Script]
囯乐酱酒_获取cookie = type=http-response,pattern=^https:\/\/member\.guoyuejiu\.com\/api\/user\/history,script-path=https://raw.githubusercontent.com/AZ-Y/scriptable/main/gljjrw.js,requires-body=1,max-size=0
